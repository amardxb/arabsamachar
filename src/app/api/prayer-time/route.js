export const revalidate = 60 // 1 minute cache, prayer times rarely change within this window
...
export async function GET(req) {
    ...
    try {
        ...
        const res = await fetch(url, { next: { revalidate: 60 } })  // route.js wale me 60
